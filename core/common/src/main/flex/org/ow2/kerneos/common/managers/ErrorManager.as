...
public class ErrorManager {
    ...
    public static function handleError(error:Object, manager:ErrorManager = null):Boolean {
        ...
        if (error is Event) {
            ...
            if (errorEvent is FaultEvent) {
                ...
                if (faultEvent.fault.faultCode == "Server.Security.AccessDenied") {
                    serverSideExceptionEvent = new ServerSideExceptionEvent(
                    ...
                    return handleError(faultEvent.fault.rootCause, manager);
                }
