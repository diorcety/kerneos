...
public class KerneosCore implements IKerneosCore {
    ...
    private synchronized void start() throws IOException {
        ...
        // Gravity Configurations
        {
            ...
            gravitySecurity = configurationAdmin.createFactoryConfiguration(org.ow2.kerneos.core.impl.granite.GraniteSecurityWrapper.class.getName(), null);
        ...
        // Granite Configurations
        {
            ...
            graniteSecurity = configurationAdmin.createFactoryConfiguration(org.ow2.kerneos.core.impl.granite.GraniteSecurityWrapper.class.getName(), null);
