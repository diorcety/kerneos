...
public class KerneosLifeCycleManager {
    ...
    public static function setupKerneosServices(e:Event = null):void {
        ...
        serviceLocator.getConsumer("kerneosAsyncConfigService").topic = "org/kerneos/modules/flex";
        ...
        serviceLocator.getConsumer("kerneosAsyncProfileService").topic = "org/kerneos/application/" + application + "/profile/flex";
    }
