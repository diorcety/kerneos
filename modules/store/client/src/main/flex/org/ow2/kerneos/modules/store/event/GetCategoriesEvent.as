...
public class GetCategoriesEvent extends CairngormEvent {
    ...
    public static var GET_CATEGORIES:String = "GET_CATEGORIES";

    public function GetCategoriesEvent(type:String) {
        super(type);
    }
    ...
    override public function clone():Event {
        var ev:GetCategoriesEvent = new GetCategoriesEvent(this.type);
