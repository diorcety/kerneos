...
public class GetStoreInfo implements ICommand, IResponder {
    ...
    public function execute(event:CairngormEvent):void {
        ...
        var parameters:String = (event as GetOrDeleteStoreEvent).url;
    ...
    public function result(data:Object):void {
        ...
        moduleModel.currentStore = (data as ResultEvent).result as org.ow2.kerneos.modules.store.vo.StoreVO;
    }
