...
public class ModulesLifeCycleManager
{
    ...
    /**
     * Setup the modules and start the ones that should be.
     */
    public static function setupModules(e : Event = null) : void
    {
    ...
    private static function setupModulesCollection(modules : ArrayCollection) : void
    {
        ...
        {
            serviceLocator.getRemoteObject(id).channelSet = KerneosMainView.amfChannelSet;
        }
    }
}
}
